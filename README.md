...
A package overview is provided below:
...
2.  ***CanTrans*** for identifying canonical transcripts in your
    dataset.

3.  ***PlotTransCan*** for plotting canonical transcript composition in
    your dataset.
